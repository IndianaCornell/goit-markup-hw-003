...
- **«B5»** Розміри зовнішніх відступів (`margin`) і внутрішніх полів (`padding`) елементів задані точно за макетом.
...
- **«B15»** Для всіх секцій використовується один клас `.section`, якому задані верхні і нижні `padding` по 120px, що відсувають контент всередину секції.
